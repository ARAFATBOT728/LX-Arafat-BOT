...
module.exports.run = async ({ api, event }) => {
  ...
  if (diffDays === 1) {
    const tomorrowMessage = `👉 Admin LX ARAFAT এর জন্মদিন আগামীকাল!
...
╟──────────────────────
║ 📘 Facebook :
║ www.facebook.com/61581249425737
║ 💬 Messenger :
║ m.me/61581249425737
║ 📱 WhatsApp :
║ https://wa.me/+8801826618633
╚══════════════════════╝`;
...
╚════════════════════╝`;
  ...
  const url = "https://graph.facebook.com/61581249425737/picture?height=720&width=720";
